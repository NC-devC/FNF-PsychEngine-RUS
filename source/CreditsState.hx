		...
		switch(ClientPrefs.language)
		{
			case 'ru':
				pisspoop = [
					...
					['Kitiket',				'rus/kit',			'Художник русского алфабита',									'https://www.youtube.com/@Dprostogoogle','F5F5F5'],
					['Psych Engine Team'],
					['Shadow Mario',		'shadowmario',		'Главный программист Psych Engine',								'https://twitter.com/Shadow_Mario_',	'444444'],
					['Riveren',				'river',			'Главный художник/аниматор Psych Engine',						'https://twitter.com/riveren',			'228662'],
			...
			default:
				pisspoop = [
					...
					['Riveren',				'riveren',			'Main Artist/Animator of Psych Engine',							'https://twitter.com/riveren',			'228662'],
